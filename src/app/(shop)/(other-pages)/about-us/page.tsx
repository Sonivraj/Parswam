    ...
    <div className="container mt-16 pb-16 sm:mt-24 lg:mt-28">
      ...
      <div className="mt-24 sm:mt-28 lg:mt-40">
        <Heading level={2} bigger>
          Welcome to <span data-slot="italic">Parswam</span> <br />
        ...
        <div className="mt-14 flex flex-col justify-between gap-10 lg:flex-row">
          ...
          <div className="flex-5/9 self-end">
            <div className="mx-auto max-w-sm">
              <Text className="mt-8">
                Drawing from our rich fashion legacy of over 15 years and embracing contemporary style, we aim to create
                trendsetting bottom wear that is incredibly stylish and comfortable.
              </Text>
              ...
              <div className="mt-24">
                ...
                <Text className="mt-8">
                  Our simple philosophy in all that we do. We are passionate about fashion, we are Parswam.
                </Text>
              </div>
              ...
              <div className="mt-11">
                ...
                <Text className="mt-8">
                  We aim to create style without compromising on comfort or quality, making fashion accessible to
                  everyone who values both trends and tradition.
                </Text>
              </div>
            </div>
          </div>
